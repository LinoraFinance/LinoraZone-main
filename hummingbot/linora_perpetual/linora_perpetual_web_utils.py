...
class linoraPerpetualRESTPostProcessor(RESTPostProcessorBase):
...
class linoraPerpetualRESTPreProcessor(RESTPreProcessorBase):
...
def build_api_factory(
    ...
    api_factory = WebAssistantsFactory(
        throttler=throttler,
        rest_pre_processors=[linoraPerpetualRESTPreProcessor()],
        rest_post_processors=[linoraPerpetualRESTPostProcessor()],
        auth=auth)
    return api_factory
