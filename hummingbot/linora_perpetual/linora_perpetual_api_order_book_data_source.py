...
class linoraPerpetualAPIOrderBookDataSource(PerpetualAPIOrderBookDataSource):
    ...
    def __init__(
            ...
            connector: 'linoraPerpetualDerivative',
    ...
    def _next_funding_time(self) -> int:
        """
        Funding premium is updated every 5 seconds as mentioned in https://docs.linora.trade/risk-system/funding-mechanism
        """
        return time.time() + 5
